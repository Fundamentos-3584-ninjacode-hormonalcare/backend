...
/**
 * Configuración específica para los endpoints de Actuator.
 * Esta clase se encarga de configurar correctamente el mapeo de endpoints
 * para asegurar la compatibilidad con CORS y otras configuraciones.
 */
@Configuration
public class ActuatorEndpointConfig {

    /**
     * Bean para configurar correctamente los endpoints de Actuator con CORS
     */
    @Bean
